  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <a class="dropdown-item" href="tambahdatamahasiswa.php"> Tambah Data Mahasiswa</a>
          <a class="dropdown-item" href="tambah.php">Tabel Mahasiswa Intitut Teknologi Garut (ITG) </a>
