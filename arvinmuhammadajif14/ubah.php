...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-lg-3">
        ...
        <input type="text" name="gambarlama" value="<?= $data["gambar"]; ?>"> 
      <form action="" method="post" enctype="multipart/form-data" >
        ...
        <div class="form-group">
                  ...
                  <option value="<?= $data["jurusan"];?>" class="form-control"><?= $data["jurusan"];?></option>
        ...
        <div class="form-group">
          ...
          <img src="img/<?= $data["gambar"];?>" alt="<?= $data["gambar"];?>" width="50"> <br>
          <!-- <textarea name="gambar" id=gambar class="form-control"  placeholder="Masukan Gambar Anda" required "></textarea> -->
          <input type="file" class="form-control" name = "gambar" id="gambar" aria-describedby="gambarHelp" placeholder="Masukan Email" aria-label="Upload" aria-selected="<?= $data["gambar"];?>">
        </div>
        <br>
