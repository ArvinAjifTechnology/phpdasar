...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-success">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      <a class="nav-link active" href="../view/index.php">Home <span class="sr-only">(current)</span></a>
      <a class="nav-link" href="../view/smkplussukaraja.php">SMK PLUS SUKARAJA</a>
      <a class="nav-link" href="../view/formulir.php">Formulir</a>
